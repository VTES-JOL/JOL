          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendCommand('unlock')">Unlock</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendCommand('edge')">Edge</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendCommand('edge burn')">Burn edge</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendCommand('draw')">Draw</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendCommand('draw crypt')">Draw crypt</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendCommand('discard random')">Discard random</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendCommand('shuffle')">Shuffle</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendCommand('shuffle crypt')">Shuffle crypt</button>

                <button type="button" class="btn btn-sm btn-outline-success m-1" onclick="sendCommand('pool +1')">Pool +1</button>
                <button type="button" class="btn btn-sm btn-outline-success m-1" onclick="sendCommand('pool +2')">+2</button>
                <button type="button" class="btn btn-sm btn-outline-success m-1" onclick="sendCommand('pool +3')">+3</button>

                <button type="button" class="btn btn-sm btn-outline-danger m-1" onclick="sendCommand('pool -1')">Pool -1</button>
                <button type="button" class="btn btn-sm btn-outline-danger m-1" onclick="sendCommand('pool -2')">-2</button>
                <button type="button" class="btn btn-sm btn-outline-danger m-1" onclick="sendCommand('pool -3')">-3</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendChat('Yes')">Yes</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendChat('No')">No</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendChat('Wait')">Wait</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendChat('1')">1</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendChat('2')">2</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendChat('3')">3</button>
                <button type="button" class="btn btn-sm btn-outline-secondary m-1" onclick="sendChat('4')">4</button>
                ...
                <button type="button" class="btn btn-sm btn-outline-danger m-1" onclick="sendChat('Long')">Long</button>
                <button type="button" class="btn btn-sm btn-outline-danger m-1" onclick="sendChat('No grapple')">No grapple</button>
                ...
                <button type="button" class="btn btn-sm btn-outline-danger m-1" onclick="sendChat('No additional strikes')">No additional strikes</button>
