...
<html>
    <head>
        ...
        <script type='text/javascript' src='${pageContext.request.contextPath}/js/ds.js?version=1.1.3'></script>
        <script src='https://www.google.com/recaptcha/api.js'></script>
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/styles.css?version=1.1.3"/>
