          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <button type="button" class="btn btn-outline-success m-1" onclick="sendCommand('pool +1')">Pool +1</button>
                ...
                <button type="button" class="btn btn-outline-danger m-1" onclick="sendCommand('pool -1')">Pool -1</button>
