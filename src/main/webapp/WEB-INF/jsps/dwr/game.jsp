...
<TABLE width=100% border=2>
    <TR>
        ...
        <td id="dsForm">
            <form onsubmit="javascript:return dosubmit();">
                <table>
                    <tr id="phasecommand">
                        <td>Phase:</td>
                        <td><select id="phase" name="phase"/></td>
                    </tr>
                    <tr>
                        <td>Command:</td>
                    ...
                    <tr>
                        <td>Ping:</td>
                        <td><select id="ping" name="ping"/></td>
                    </tr>
                    <tr id="endcommand">
                        <td>End turn?</td>
                        <td><select id="endturn" name="endturn">
                    ...
                    <tr>
                        <td colspan="2"><span id="status"/></td>
                    </tr>
                </table>
            </form>
        </td>
    ...
    <tr>
        <td align=left><font color=yellow>
            <table>
                <tr>
                    <td align=left>
                        <div id="gamename"></div>
    ...
    <tr>
        ...
        <td colspan="2">
            <div class="history" id="extra"><input type=hidden id="extraSelect" value="history"/>
                <div id="history"/>
            </div>
        </td>
    </TR>
