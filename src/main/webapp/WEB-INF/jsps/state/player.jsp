...
<table>
    <tr>
        ...
        <td align=center><FONT
                COLOR=teal>Crypt:<% out.write(String.valueOf(game.getState().getPlayerLocation(player,JolGame.CRYPT).getCards().length)); %><BR>
        </td>
        <td align=right><FONT
                COLOR=fuschia>Hand:<% out.write(String.valueOf(game.getState().getPlayerLocation(player,JolGame.HAND).getCards().length)); %><BR>
        </td>
    </tr>
</table>
<HR>
