...
<div class="container-fluid tab-pane fade show active" role="tabpanel" aria-labelledby="help1" tabindex="0" id="panel1">
    <div id="cardNames">
        <h4>Card Names</h4>
        Because JOL uses text based deck lists there are some rules to make sure the decks can be parsed into valid
        cards. Each card has one or more unique ways to distinguish it from other cards in the collection.
        <table class="table mt-2">
            ...
            <tr>
                ...
                <td>Card names are taken from the <a href="https://www.vekn.net/images/stories/downloads/cardlist.txt"
                                                     target="_blank">VEKN Official Card Text</a></td>
            ...
            <tr>
                <th>Commas</th>
                <td>Cards listed in the official list that end with <strong>, The</strong> also have an option to
                    include <strong>The</strong> at the start of the name as well.
                </td>
            ...
            <tr>
                ...
                <td>To simplify typing card names, any official name, or alias that contains Unicode characters will
                    have an alias created with the characters replaced
                </td>
            ...
            <tr>
                <th>Advanced</th>
                <td>To distinguish advanced vampires from their base the suffix <strong>ADV</strong> is added in
                    parentheses to the end of the name
                </td>
            ...
            <tr>
                <th>Grouping</th>
                <td>
                    Vampires with the same name, but in different groups can be distinguished by adding the group number
                    in parentheses to the end of the name. If the vampire is also Advanced the ADV suffix comes
                    last.<br/>
    ...
    <hr class="my-4"/>
    <div id="deckEditor">
        <h4>Using the Deck Editor</h4>
        The deck editor function is very basic, there is no search option. There are dedicated sites that are better
        suited to searching and building your deck. See the links below.
        <ul>
        ...
        However, the deck editor will assist you in making sure the cards you have entered are in a valid format, and
        will highlight errors where it can't find the card specified.<br/>
        A preview screen is located in the middle that will show the current deck contents, and the grouping / card
        count at the top of the screen
        <div class="card-header bg-body-secondary d-flex justify-content-between align-items-center w-75 w-md-50 my-2 ms-4">
            <h5 class="d-inline">Preview</h5>
            <span id="deckSummary" class="d-flex justify-content-between align-items-center gap-1"><span>Crypt: 13 Library: 67 Groups: 6</span><span
                    class="badge badge-sm text-bg-success">VALID</span></span>
        </div>
        Decks that have been created previously and have not been saved in the modern JOL format will have a label
        beside their name of <span class="badge text-bg-warning">LEGACY</span><br/>
        These are decks that have not been automatically parsed and contain errors, you will have to manually inspect
        the deck, confirm the contents, and save the deck to convert it into the <span class="badge text-bg-secondary">MODERN</span>
        format required to play.
    </div>
</div>