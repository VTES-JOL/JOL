<div class="container-fluid pt-2">
  ...
  <div class="mt-2">
    <nav class="nav nav-tabs" id="helpTab" role="tablist">
      ...
      <button class="nav-link" data-bs-toggle="tab" type="button" role="tab" aria-selected="false" id="help3" data-bs-target="#panel3" aria-controls="panel3">Managing counters</button>
      <button class="nav-link" data-bs-toggle="tab" type="button" role="tab" aria-selected="false" id="help4" data-bs-target="#panel4" aria-controls="panel4">Moving cards</button>
