    ...
    <div class="mt-2">
        <nav class="nav nav-pills" id="helpTab" role="tablist">
            ...
            <a class="nav-link" data-bs-toggle="tab" href="#join" type="button" role="tab" aria-selected="false"
               id="help2" data-bs-target="#panel2" aria-controls="panel2">Joining Games</a>
            <a class="nav-link" data-bs-toggle="tab" href="#gameInfo" type="button" role="tab" aria-selected="false"
               id="help6" data-bs-target="#panel6" aria-controls="panel6">Game Information</a>
            <a class="nav-link" data-bs-toggle="tab" href="#cards" type="button" role="tab" aria-selected="false"
               id="help3" data-bs-target="#panel3" aria-controls="panel3">Moving cards</a>
            <a class="nav-link" data-bs-toggle="tab" href="#counters" type="button" role="tab" aria-selected="false"
               id="help4" data-bs-target="#panel4" aria-controls="panel4">Managing counters</a>
            <a class="nav-link" data-bs-toggle="tab" href="#cardInfo" type="button" role="tab" aria-selected="false"
               id="help5" data-bs-target="#panel5" aria-controls="panel5">Card Information</a>
            <a class="nav-link" data-bs-toggle="tab" href="#tips" type="button" role="tab" aria-selected="false"
               id="help7" data-bs-target="#panel7" aria-controls="panel7">Tips</a>
        </nav>
