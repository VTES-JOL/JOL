...
<div class="container-fluid tab-pane fade" role="tabpanel" aria-labelledby="help2" tabindex="0" id="panel2">
    ...
    <div id="privateGames">
        ...
        registered players
        <div class="card shadow w-75 w-md-50 my-2">
    ...
    <div id="publicGames">
        ...
        <p>
            Public games expire after 5 days, the expiry time alongside the game name. When a player registers a deck to
            a public game, this expiry time is refreshed. This is in place to make sure that game spots are continually
            being utilized fully<br/>
        </p>
        <p>
        ...
        <div class="card shadow my-2 w-75 w-md-50">
            <div class="card-header bg-body-secondary">
                <h5>Public Games</h5>
            </div>
    ...
    <div id="deckRegistration">
        <h4>Registering a Deck</h4>
        <p>
            You register your deck for both private and public games in the <strong>Register Deck</strong> section
        </p>
        All your valid decks that are in the <span class="badge text-bg-secondary">MODERN</span> format will be
        available.
        ...
        <div class="card shadow w-75 w-md-50 my-2">
            ...
            <div class="card-footer">
                ...
                <select class="form-select" id="testDeckList" disabled>
                    <option value="Assamite Bleed Vote">Assamite Bleed Vote</option>
                </select>
                <label for="testGameList" class="form-label mt-2">Invited Games</label>
                <select class="form-select" id="testGameList" disabled>
                    <option value="Rich bushelling Wrecker">Rich bushelling Wrecker</option>
                </select>
                <button class="btn btn-outline-secondary btn-sm mt-2" disabled>Register</button>
                <div id="registerResult" class="badge text-bg-light">Successfully registered Assamite Bleed Vote in game
                    Rich bushelling Wrecker
                </div>
            </div>
        </div>
