...
<div class="row mt-2 g-2">
    ...
    <div class="col-md-8 col-lg-6 col-xl-6 d-flex flex-column gap-2">
        <jsp:include page="global-chat.jsp"/>
    </div>
    <div class="d-md-none d-lg-flex col-lg-3 col-xl-3 flex-column flex-md-row flex-lg-column gap-2">
