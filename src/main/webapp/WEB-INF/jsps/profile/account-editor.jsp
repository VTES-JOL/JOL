<div class="card shadow mb-2">
  ...
  <div class="card-body">
    ...
    <input type="password" id="profileNewPassword" placeholder="New password" autocomplete="new-password" class="form-control"/>
    <label for="profileConfirmPassword" class="form-label mt-2">Confirm Password</label>
    <input type="password" id="profileConfirmPassword" placeholder="Confirm password" autocomplete="new-password" class="form-control"/>
