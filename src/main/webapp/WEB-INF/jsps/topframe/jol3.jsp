...
<div id="loaded"
     style="display :none;">
    <div id="disabledZone"
         style="position: absolute; z-index: 1000; left: 0px; top: 0px; width: 100%; height: 100%; visibility: hidden;">
        <div id="messageZone"
             style="padding: 4px; background: red none repeat scroll 0%; position: absolute; top: 0px; right: 0px; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; color: white; font-family: Arial,Helvetica,sans-serif;">
            Loading
        </div>
    </div>
