/**
 * This generated bean class Region matches the schema element 'region'.
...
public class Region extends org.netbeans.modules.schema2beans.BaseBean {
    ...
    public int addNotation(javaclient.gen.Notation value) {
    ...
    //
    public int removeNotation(javaclient.gen.Notation value) {
    ...
    // Add a new element returning its index in the list
    public int addGameCard(javaclient.gen.GameCard value) {
    ...
    // Returns the index the element had in the list
    //
    public int removeGameCard(javaclient.gen.GameCard value) {
    ...
    public void dump(StringBuffer str, String indent) {
        ...
        str.append(indent);
        str.append("GameCard[" + this.sizeGameCard() + "]");    // NOI18N
        for (int i = 0; i < this.sizeGameCard(); i++) {
            str.append(indent + "\t");
            str.append("#" + i + ":");
            n = (org.netbeans.modules.schema2beans.BaseBean) this.getGameCard(i);
            if (n != null)
                n.dump(str, indent + "\t");    // NOI18N
            else
                str.append(indent + "\tnull");    // NOI18N
