...
public class V5StrictDeckValidator extends StandardDeckValidator {

    private static final List<String> sets;

    static {
        sets = IOUtils.readLines(Objects.requireNonNull(DuelDeckValidator.class.getResourceAsStream("valid-v5-strict-sets.txt")), StandardCharsets.UTF_8);
    }
