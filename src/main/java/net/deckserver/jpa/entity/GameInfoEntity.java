...
public class GameInfoEntity {
    ...
    public static GameInfoEntity from(GameInfo info, String ownerId) {
        ...
        entity.createdAt = info.getUpdated();
    ...
    public void update(GameInfo info, String ownerId) {
        // gameId must be refreshed too: a game name can legitimately be recreated
        // under a brand new id (e.g. TournamentService.recreateTable), and leaving
        // the old id in place here would silently orphan every subsequent write
        // keyed on the new id (FK violations against this row's stale gameId).
        this.gameId = info.getId();
