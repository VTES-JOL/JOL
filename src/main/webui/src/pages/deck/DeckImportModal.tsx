...
export function DeckImportModal({ onImport, onClose, onPreview = deckApi.previewImport }: Props) {
  ...
  return (
    <div className="jt:fixed jt:inset-0 jt:z-50 jt:flex jt:items-center jt:justify-center jt:p-4 jt:bg-black/60 jt:backdrop-blur-sm">
      <div className="jt:relative jt:flex jt:flex-col jt:w-full jt:max-w-lg jt:max-h-[85dvh] jt:rounded-lg jt:border jt:border-line-accent jt:bg-surface jt:shadow-xl">
        <div className="jt:flex jt:items-center jt:justify-between jt:px-4 jt:py-3 jt:border-b jt:border-line/75 jt:bg-panel/45">
          <h2 className="jt:text-sm jt:font-medium jt:text-ink jt:tracking-wide">Import Deck</h2>
          <button onClick={onClose} className="jt:p-1 jt:rounded jt:hover:bg-hover jt:transition-colors jt:cursor-pointer">
            <X className="jt:w-4 jt:h-4 jt:text-ink-muted" />
          </button>
        </div>

        <div className="jt:flex jt:flex-col jt:gap-3 jt:p-4 jt:min-h-0 jt:overflow-y-auto jt:flex-1">
          <div>
