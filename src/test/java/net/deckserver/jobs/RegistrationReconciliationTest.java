...
class RegistrationReconciliationTest {
    ...
    void removes_stale_registration_for_player_not_seated_in_active_game() throws IOException {
        ...
        RegistrationService.registerDeck(gameName, "Player1", "deck-1", "Deck One", "summary", null);
        RegistrationService.registerDeck(gameName, "Player2", "deck-2", "Deck Two", "summary", null);
        RegistrationService.registerDeck(gameName, "PlayerGhost", "deck-3", "Ghost Deck", "summary", null);
    ...
    void non_active_game_is_left_untouched() {
        ...
        RegistrationService.registerDeck(gameName, "PlayerGhost", "deck-2", "Ghost Deck", "summary", null);
