...
<li><a href="<% out.write(params.getPrefix()); %>?page=show&deck=<% out.write(decks[i]); %>"><% out.write(decks[i]); %></a></li>
<%          }
        } %>
</ul>
<%  } %>
...
<%      for(int i = 0; i < games.length; i++) {
            if(admin.isOpen(games[i])) invites = true;
            else { %>
<li><a href="<% out.write(params.getPrefix() + games[i]); %>"><% out.write(games[i]); %></a></li>
<%          }
        } %>
</ul>
<%  }
