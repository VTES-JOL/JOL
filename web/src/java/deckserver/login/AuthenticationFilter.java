...
public class AuthenticationFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) {
        try {
            new JolAdmin(filterConfig.getInitParameter("directory"));
        } catch (Exception e) {
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        //
        protected Hashtable<Object, Object> localParams = null;
		...
		public void setParameter(String name, String []values) {
            ...
            if (localParams == null) {
                localParams = new Hashtable<Object, Object>();
                //
                // Copy the parameters from the underlying request.
                Map<Object, Object> wrappedParams = getRequest().getParameterMap();
                Set<Object> keySet = wrappedParams.keySet();
		...
		public Enumeration<Object> getParameterNames() {
            ...
            if (localParams == null)
                return (Enumeration<Object>) getRequest().getParameterNames();
		...
		public Map<Object, Object> getParameterMap() {
            ...
            if (localParams == null)
                return (Map<Object,Object>) getRequest().getParameterMap();
            return localParams;
        }
    }
